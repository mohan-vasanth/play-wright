...
class OutDeclarationPartyUiTest extends BaseTest {
    ...
    @Test
    void fillPartyInfoPopulatesDeclarantAndManufacturerSubdivisionFields() throws Exception {
        page.setContent("""
                <html>
                <body>
                  <section id="party-section" style="padding:12px; border:1px solid #ccc; width:1200px;">
                    ...
                    <div style="display:grid; grid-template-columns:1fr; gap:12px; margin-bottom:12px;">
                      <div>
                        <div>Declarant Agent / Party Code / UEN</div>
                        <input id="declarant-code" type="text" style="width:320px; height:28px;">
                      </div>
                      <div>
                        <div>Declarant Agent / Party Name</div>
                        <input id="declarant-name" type="text" style="width:320px; height:28px;">
                      </div>
                      <div>
                        <div>Declarant Agent / Party Telephone</div>
                        <input id="declarant-telephone" type="text" style="width:320px; height:28px;">
                      </div>
                    </div>
                    ...
                    <div id="manufacturer-card" style="border:1px solid #ddd; padding:16px; margin-top:16px;">
                      ...
                      <div style="margin-top:12px;">
                        ...
                        <input id="manufacturer-address-1" type="text" style="width:520px; height:28px;">
                      </div>
                      <div style="margin-top:12px;">
                        <div>Address Line 2</div>
                        <input id="manufacturer-address-2" type="text" style="width:520px; height:28px;">
                      </div>
                      <div style="margin-top:12px;">
                        <div>City</div>
                        <input id="manufacturer-city" type="text" style="width:220px; height:28px;">
                      ...
                      <div style="margin-top:12px;">
                        ...
                        <input id="manufacturer-subdivision-code" type="text" style="width:220px; height:28px;">
                      </div>
                      <div style="margin-top:12px;">
                        <div>Subdivision Name</div>
                        <input id="manufacturer-subdivision-name" type="text" style="width:220px; height:28px;">
                      </div>
                      <div style="margin-top:12px;">
                        <div>Postal Code</div>
                        <input id="manufacturer-postal" type="text" style="width:140px; height:28px;">
                          ...
                          "party": {
                            ...
                            "manufacturerParty": {
                              ...
                              "address": {
                                ...
                                "cityName": "TRICHY",
                                "countrySubentityCode": "TN",
                                "countrySubentity": "TAMILNADU",
                                "postalZone": "620001",
                                "countryCode": "IN"
                              }
                            }
        ...
        assertEquals("S8562791J", page.locator("#declarant-code").inputValue());
        assertEquals("NAMASIVAYAM GUNESPARAN", page.locator("#declarant-name").inputValue());
        assertEquals("81189066", page.locator("#declarant-telephone").inputValue());
        assertEquals("ARMSTRONG INDUSTRIAL CORP", page.locator("#manufacturer-name").inputValue());
        assertEquals("198003808K", page.locator("#manufacturer-uen").inputValue());
        assertEquals("ADD1, ADD3, TRICHY", page.locator("#manufacturer-address").inputValue());
        assertEquals("ADD1", page.locator("#manufacturer-address-1").inputValue());
        assertEquals("ADD3", page.locator("#manufacturer-address-2").inputValue());
        assertEquals("TRICHY", page.locator("#manufacturer-city").inputValue());
        assertEquals("TN", page.locator("#manufacturer-subdivision-code").inputValue());
        assertEquals("TAMILNADU", page.locator("#manufacturer-subdivision-name").inputValue());
        assertEquals("620001", page.locator("#manufacturer-postal").inputValue());
        assertEquals("IN", page.locator("#manufacturer-country").inputValue());
    }
                ...
                <body>
                  <section id="party-section" style="padding:12px; border:1px solid #ccc; width:1200px;">
                    ...
                    <div style="display:grid; grid-template-columns:160px 360px 40px 220px; gap:12px; align-items:center; margin-bottom:12px;">
                      ...
                      <app-inward-carrier-lookup id="inward-host" formcontrolname="name" style="display:block;">
                        <input id="inward-name" type="text" style="width:320px; height:28px;">
                      </app-inward-carrier-lookup>
                      <div>🔍</div>
                      <input id="inward-uen" type="text" style="width:220px; height:28px;">
                    </div>
                  ...
                  <script>
                    (() => {
                      ...
                      window.ng = {
                        getComponent(target) {
                          if (target === importer.host) return importer.component;
                          if (target === inward.host) return inward.component;
